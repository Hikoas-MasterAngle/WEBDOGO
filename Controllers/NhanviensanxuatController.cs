        ...
        public ActionResult luutiendosanxuat(quanlttiendo qltd)
        {
            ...
            else
            {
                if (qltd.sTIENDOSANXUAT.NGHIEMTHU == "Phê duyệt")
                {
                    ...
                    {
                        var tdcantim = db.TIENDOSANXUATs.AsNoTracking().SingleOrDefault(x => x.MATIENDOSANXUAT == qltd.sTIENDOSANXUAT.MATIENDOSANXUAT);
                        qltd.sTIENDOSANXUAT.NGAYDUKIENHOANTHANH = tdcantim.NGAYDUKIENHOANTHANH;
